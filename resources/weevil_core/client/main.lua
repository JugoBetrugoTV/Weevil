--[[
    Weevil Multi-Gamemode - Client Main Script
...
addEventHandler("onClientResourceStart", resourceRoot, function()
    ...
    outputChatBox("#FF6600[Weevil] #FFFFFFClient initialized. Press F1 for help.", 255, 255, 255, true)
end)
...
addEventHandler(Events.Currency.UPDATE_MONEY, root, function(newBalance, change)
    ...
    if change and change ~= 0 then
        ...
        exports.weevil_core:showNotification("info", color .. "$" .. Utils.formatNumber(math.abs(change)), 3000)
    end
end)
...
addEventHandler(Events.Currency.UPDATE_POINTS, root, function(newPoints, change, gamemode)
    ...
    if change and change ~= 0 then
        ...
        exports.weevil_core:showNotification("info", color .. Utils.formatNumber(math.abs(change)) .. " pts" .. gmText, 3000)
    end
end)
...
addEventHandler(Events.Currency.REWARD_RECEIVED, root, function(data)
    if data.type == "money" then
        exports.weevil_core:showNotification("success", "+$" .. Utils.formatNumber(data.amount) .. (data.reason and (" - " .. data.reason) or ""), 4000)
    elseif data.type == "points" then
        exports.weevil_core:showNotification("success", "+" .. Utils.formatNumber(data.amount) .. " pts" .. (data.reason and (" - " .. data.reason) or ""), 4000)
    end
end)
...
addEventHandler(Events.Arena.COUNTDOWN, root, function(seconds)
    if seconds <= 5 then
        exports.weevil_core:showNotification("warning", tostring(seconds), 1000)
        exports.weevil_core:playSound("countdown")
    end
end)

addEvent(Events.Arena.ROUND_START, true)
addEventHandler(Events.Arena.ROUND_START, root, function(data)
    exports.weevil_core:showNotification("success", "GO!", 2000)
    exports.weevil_core:playSound("start")
end)

addEvent(Events.Arena.ROUND_END, true)
addEventHandler(Events.Arena.ROUND_END, root, function(data)
    exports.weevil_core:showNotification("info", "Round Over!", 3000)
...
bindKey("F7", "down", function()
    ...
    exports.weevil_core:showNotification("info", "HUD " .. (hudVisible and "enabled" or "disabled"), 2000)
end)

-- Key bindings
bindKey("F1", "down", function()
    outputChatBox("#FF6600=== Weevil Gaming Keybinds ===", 255, 255, 255, true)
...
-- Export functions
exports.weevil_core = exports.weevil_core or {}
exports.weevil_core.getLocalPlayerData = getLocalPlayerData
exports.weevil_core.getCurrentGamemode = getCurrentGamemode
exports.weevil_core.isPlayerInLobby = isPlayerInLobby
exports.weevil_core.getPlayerMoney = getPlayerMoney
exports.weevil_core.getPlayerPoints = getPlayerPoints
