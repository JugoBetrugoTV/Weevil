--[[
    Weevil Multi-Gamemode - Garage System
]]
...
function purchaseVehicle(player, vehicleId)
    ...
    local playerMoney = exports.weevil_core:getPlayerMoney(player)
    ...
    -- Deduct money
    exports.weevil_core:removePlayerMoney(player, vehicleInfo.price, "Vehicle purchase: " .. vehicleInfo.name)
