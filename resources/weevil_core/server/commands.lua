--[[
    Weevil Multi-Gamemode - Server Commands
...
addCommandHandler("help", function(player)
    outputChatBox("#FF6600=== Weevil Gaming Commands ===", player, 255, 255, 255, true)
...
addCommandHandler("lobby", function(player)
    ...
    outputChatBox("#00FF00[Weevil] #FFFFFFYou returned to the lobby.", player, 255, 255, 255, true)
end)
...
addCommandHandler("leave", function(player)
    ...
    removePlayerFromArena(player, gamemode)
    outputChatBox("#00FF00[Weevil] #FFFFFFYou left " .. Config.Gamemodes[gamemode].name .. ".", player, 255, 255, 255, true)
end)
