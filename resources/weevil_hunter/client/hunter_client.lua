--[[
    Weevil Multi-Gamemode - Hunter (Helicopter Combat)
...
addEventHandler("onClientResourceStart", resourceRoot, function()
    outputDebugString("[Weevil Hunter] Hunter client initialized")
end)
...
addEventHandler("onClientVehicleExplode", root, function()
    ...
    if getPedOccupiedVehicle(localPlayer) == vehicle then
        isEliminated = true
        exports.weevil_core:showNotification("error", "Your helicopter was destroyed!", 3000)
    end
end)
