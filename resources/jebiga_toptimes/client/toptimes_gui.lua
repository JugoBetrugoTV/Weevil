--[[
    Jebiga Multi-Gamemode - TopTimes GUI
...
addEventHandler(Events.TopTimes.NEW_TOPTIME, root, function(data)
    ...
    if data.isNew then
        exports.jebiga_core:showNotification("achievement", "New record! " .. posText .. " place: " .. timeText, 5000)
    else
        exports.jebiga_core:showNotification("success", "Improved to " .. posText .. " place: " .. timeText, 4000)
    end

    exports.jebiga_core:playSound("finish")
end)
