--[[
    Jebiga Multi-Gamemode - Hot Pursuit
...
addEventHandler("onResourceStart", resourceRoot, function()
    outputDebugString("[Jebiga HP] Hot Pursuit gamemode initialized")
end)
...
addEventHandler("weevil:hp:catch", root, function(racerElement)
    ...
    exports.jebiga_core:addPlayerPoints(police, 8, GAMEMODE)
    exports.jebiga_core:addPlayerMoney(police, 25, "HP Catch")
...
addEventHandler("weevil:hp:finish", root, function()
    ...
    exports.jebiga_core:addPlayerPoints(racer, 15, GAMEMODE)
    exports.jebiga_core:addPlayerMoney(racer, 40, "HP Escape")
