--[[
    Weevil Multi-Gamemode - TopTimes System
...
function addTopTime(player, mapName, gamemode, timeMs, vehicleId)
    ...
    local accountId = exports.weevil_core:getPlayerAccountId(player)
    ...
    -- Insert or update
    local success = dbExec(exports.weevil_core:dbExec, [[
    ...
    if success then
        ...
        if position then
            ...
            if position <= 3 then
                ...
                exports.weevil_core:broadcastToGamemode(gamemode,
...
addEventHandler("weevil:newTopTime", root, function(mapName, gamemode, position, timeMs)
    ...
    if totalToptimes >= 1 then
        exports.weevil_achievements:unlockAchievement(player, "toptime_1")
    end
    if totalToptimes >= 10 then
        exports.weevil_achievements:unlockAchievement(player, "toptime_10")
    end
end)
...
addCommandHandler("toptimes", function(player, cmd, mapName)
    ...
    local gamemode = exports.weevil_core:getCurrentGamemode(player) or "race"
...
-- Export functions
exports.weevil_toptimes = exports.weevil_toptimes or {}
exports.weevil_toptimes.getTopTimes = getTopTimes
exports.weevil_toptimes.addTopTime = addTopTime
exports.weevil_toptimes.getPlayerTopTime = getPlayerTopTime
