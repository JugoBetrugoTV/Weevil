--[[
    Weevil Multi-Gamemode - Run Arena
...
addEventHandler("onResourceStart", resourceRoot, function()
    outputDebugString("[Weevil Run] Run Arena gamemode initialized")
end)
...
addEventHandler("weevil:run:checkpoint", root, function(index)
    ...
    if index == runData.players[player].checkpoint + 1 then
        ...
        if index >= #runData.checkpoints then
            ...
            exports.weevil_core:addPlayerFinish(player, GAMEMODE, getTickCount() - (runData.roundStartTime or 0))
