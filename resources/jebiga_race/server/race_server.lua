--[[
    Jebiga Multi-Gamemode - Race (Oldschool)
...
addEventHandler("onResourceStart", resourceRoot, function()
    outputDebugString("[Jebiga Race] Oldschool Race gamemode initialized")
end)
...
function playerFinished(player)
    ...
    exports.jebiga_core:addPlayerFinish(player, GAMEMODE, finishTime)

    -- Try to add top time
    if raceData.currentMap then
        exports.jebiga_toptimes:addTopTime(player, raceData.currentMap, GAMEMODE, finishTime, nil)
    end
