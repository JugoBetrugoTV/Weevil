--[[
    Weevil Multi-Gamemode - Database Module
...
function initDatabase()
    ...
    if connection then
        isConnected = true
        outputDebugString("[Weevil] Database connected successfully")
        createTables()
        return true
    else
        isConnected = false
        outputDebugString("[Weevil] Database connection failed!", 1)
        return false
    end
end
...
function createTables()
    ...
    outputDebugString("[Weevil] Database tables created/verified")
end
...
function closeDatabase()
    if connection then
        ...
        connection = nil
        isConnected = false
        outputDebugString("[Weevil] Database connection closed")
    end
end
