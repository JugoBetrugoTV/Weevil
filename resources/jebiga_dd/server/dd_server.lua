--[[
    Jebiga Multi-Gamemode - DD (Destruction Derby)
...
addEventHandler("onResourceStart", resourceRoot, function()
    outputDebugString("[Jebiga DD] Destruction Derby gamemode initialized")
end)
...
function eliminatePlayer(player, killer)
    ...
    exports.jebiga_core:addPlayerElimination(player, GAMEMODE, killer)
