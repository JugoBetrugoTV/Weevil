--[[
    Jebiga Multi-Gamemode - Stuntage
...
addEventHandler("onResourceStart", resourceRoot, function()
    ...
    outputDebugString("[Jebiga Stuntage] Stuntage gamemode initialized with " .. #STUNTS .. " stunts")
end)
...
addEventHandler("weevil:stuntage:complete", root, function(stuntIndex)
    ...
    exports.jebiga_core:addPlayerPoints(player, stunt.points, GAMEMODE)
    exports.jebiga_core:addPlayerMoney(player, stunt.points * 2, "Stunt: " .. stunt.name)
    ...
    if completedCount >= 100 then
        exports.jebiga_achievements:unlockAchievement(player, "stunt_100")
    end
end)
