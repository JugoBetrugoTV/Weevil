--[[
    Jebiga Multi-Gamemode - Sound System
...
-- Export functions
function exports.jebiga_core:playSound(soundName)
    playSound(soundName)
end

function exports.jebiga_core:playCustomSound(url, volume, loop)
    return playCustomSound(url, volume, loop)
end

function exports.jebiga_core:playMusic(url, volume)
    return playMusic(url, volume)
end

function exports.jebiga_core:stopMusic()
    stopMusic()
end

function exports.jebiga_core:setMusicVolume(volume)
    setMusicVolume(volume)
end

function exports.jebiga_core:setSFXVolume(volume)
    setSFXVolume(volume)
end
