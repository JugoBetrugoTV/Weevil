--[[
    Weevil Multi-Gamemode - Achievements System
]]
...
function unlockAchievement(player, achievementId)
    ...
    if success then
        ...
        if achievement.points then
            exports.weevil_core:addPlayerPoints(player, achievement.points, nil)
        end
...
-- Exports
exports.weevil_achievements = exports.weevil_achievements or {}
exports.weevil_achievements.unlockAchievement = unlockAchievement
exports.weevil_achievements.hasAchievement = hasAchievement
exports.weevil_achievements.getPlayerAchievements = getPlayerAchievements
